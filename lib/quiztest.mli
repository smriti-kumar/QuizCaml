(** [correctness guess answer] returns a "0" or a "1 depending" on whether
...
(**[ran_list acc size progress]* returns a list of integers from 0 to [size] in
...
(**[ran_num seed] randomly returns either a 1 or 2. Requires that [seed] >= 0*)
val ran_num : int -> int

(**[grader scores count] returns the grade corresponding to [scores]. [scores]
...
(**[speak s] takes in a string [s] and returns "RIGHT" if [s] = "1" and "WRONG"
   otherwise*)
